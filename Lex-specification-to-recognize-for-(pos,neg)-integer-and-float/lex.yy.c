...
static yyconst short int yy_base[19] =
    {   0,
        0,    0,   17,   18,   13,    0,    3,   12,    0,   18,
        0,    0,   18,   18,    7,    9,   11,   10
    } ;

static yyconst short int yy_def[19] =
    {   0,
       15,   14,   14,   14,   16,   17,   14,   16,   18,   14,
       17,    7,   14,    0,   14,   14,   14,   14
    } ;

static yyconst short int yy_nxt[23] =
    {   0,
        4,    5,    6,    7,    8,   11,   12,    4,    4,    4,
        8,    8,   13,   10,    9,    9,   14,    3,   14,   14,
       14,   14
    } ;

static yyconst short int yy_chk[23] =
    {   0,
        2,    2,    2,    2,    7,    7,    7,   15,   15,   15,
       16,   16,   18,   17,    8,    5,    3,   14,   14,   14,
       14,   14
    } ;
